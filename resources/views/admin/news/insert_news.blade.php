    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <div class="box box-primary" id="text">
                <!-- /.box-header -->
                <form id="frNews" method="POST" action="{{url('admin/news-save')}}"  enctype="multipart/form-data">
                    <input type="hidden" name="_token" value="{!! csrf_token() !!}"/>
                    <div class="box-header with-border">
                        <button type="submit" id="saveNews" class="btn btn-success usersubmit" name="save"><i class="fa fa-save"></i> Lưu</button>
                        <a class="btn btn-danger" href="{{url('admin/news-home')}}"><i class="fa fa-close"></i> Hủy bỏ</a>
                    </div>
                    <div class="box-body">
