...
@section('Content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h4>Thêm Chính Sách Nhân Sự</h4>

            <ol class="breadcrumb">
                <li><a href=""><i class="fa fa-dashboard"></i> Home</a></li>
                <li class="active">Thêm chính sách nhân sự</li>
            </ol>
        </section>
        <section class="content-header">
            ...
            <div class="box box-primary" id="text">
                <!-- /.box-header -->
                <form id="frSoluoc" method="POST" action="{{url('admin/term-save')}}"  enctype="multipart/form-data">
                    ...
                    <div class="box-header with-border">
                        ...
                        <a class="btn btn-danger" href="{{url('admin/term')}}"><i class="fa fa-close"></i> Hủy bỏ</a>
                    </div>
                    <div class="box-body">
                        <div class="row col-md-12" style="padding-bottom: 10px">
                            <input hidden type="text" name="txtid" value="<?=$term ? $term->id: 0?>">
                        </div>
                        <div class="row">
                            <div class="col-md-9">
                                <div class="nav-tabs-custom">
                                    ...
                                    <div class="tab-content" id="contentSoluoc">
                                        ...
                                        @else
                                                        ...
                                                        <div class="tab-pane active" id="tab_vi">
                                                            <div class="form-group">
                                                                <input type="text" class="form-control" name="title_vi" id="title_vi" value="{{$term->title}}" placeholder="Tiêu đề" required maxlength="255">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="introduce">
                                                                    Giới thiệu
                                                                </label>
                                                                <textarea class="form-control editors" name="introduce_vi" required id="introduce_vi" rows="3">{{$term->content}}</textarea>
                                                            </div>
                                                        </div>

                                                        <div class="tab-pane" id="tab_en">
                                                            <div class="form-group">
                                                                <input type="text" class="form-control" name="title_en" id="title_en" value="{{$term->title_en}}" placeholder="Title" required maxlength="255">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="introduce">
                                                                    Introduce
                                                                </label>
                                                                <textarea class="form-control editors" name="introduce_en" required id="introduce_en" rows="3">{{$term->content_en}}</textarea>
                                                            </div>
                                                        </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    ?>
                                    <img id="imgF" src="{{asset('images/terms_web')}}/<?=$term ? $term->image: ''?>" class="img-responsive" style="height: 200px;">
                                </div>
                            </div>
                            <!-- /.col -->
                        </div>
