    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <div class="box box-primary" id="text">
                <!-- /.box-header -->
                <form id="frSoluoc" method="POST" action="{{url('admin/banner-save')}}"  enctype="multipart/form-data">
                    ...
                    <div class="box-header with-border">
                        ...
                        <a class="btn btn-danger" href="{{url('admin/banner')}}"><i class="fa fa-close"></i> Hủy bỏ</a>
                    </div>
                    <div class="box-body">
