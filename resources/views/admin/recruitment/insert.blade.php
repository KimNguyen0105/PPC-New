    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <div class="box box-primary" id="text">
                <!-- /.box-header -->
                <form id="frSoluoc" method="POST" action="{{url('admin/recruitment-save')}}"  enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        <div class="row col-md-12" style="padding-bottom: 10px">
                            <input hidden type="text" name="txtid" value="<?=$recruitment ? $recruitment->id: 0?>">
                        </div>
                        <div class="row">
                            <div class="col-md-9">
                                <div class="nav-tabs-custom">
                                    ...
                                    <div class="tab-content" id="contentSoluoc">
                                        ...
                                        @else
                                            @if($recruitment_lang!=null)
                                                @foreach($recruitment_lang as $item)
                                                    @if($item->lang=='vi')
                                                        <div class="tab-pane active" id="tab_vi">
                                                            <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="section">
                                        <label for="datepicker1" class="field prepend-icon">
                                            ...
                                            if($recruitment !=null)
                                            {
                                                $day=$recruitment->deadline;
                                            }
                                            else{
                                                $day=date("Y-m-d");
                                            }
                                            ?>
                                            <input type="text" id="datepicker1" name="datepicker1" value="<?=$day?>" class="gui-input form-control">
                                        </label>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    ?>
                                    <img id="imgF" src="{{asset('images/recruitment')}}/<?=$recruitment ? $recruitment->image: ''?>" class="img-responsive" style="height: 200px;">
                                </div>
                            </div>
                            <!-- /.col -->
                        </div>
