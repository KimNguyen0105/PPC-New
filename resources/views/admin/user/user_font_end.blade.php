...
@section('Content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <a href="{{url('admin/user-font-end')}}/0" class="btn btn-info" style="border-radius:0px;"><i class="fa fa-plus">&nbspUser</i></a>
            <ol class="breadcrumb">
                            ...
                            @foreach($user as $item)
                                <tr>
                                    ...
                                    <td  style="width: 110px">
                                        <a href="{{url('admin/user-font-end')}}/{{$item->id}}" class="btn btn-primary"><span class="fa fa-pencil"></span></a>
                                        <a href="{{url('admin/user-font-end-delete')}}/{{$item->id}}" class="btn btn-danger">
