            ...
            <div class="space" style="padding: 0px 15px">
                ...
                <div class="col-md-12 contentduan" style="margin-bottom: 10px;position: relative">
                    <div class="col-md-4" style="padding: 0px">
                        <a href="{{URL::asset('')}}ppc-recruitment-detail/{{$row->id}}-{{$row->slug}}.html">
                            <img src="{{URL::asset('')}}images/{{$row->image}}" class="img-responsive img_body" title="{{$row->slug}}"  style="width:100%;">
                        </a>
                    </div>

                    <div class="col-md-8" style="padding-top: 10px">
                        <a href="{{URL::asset('')}}ppc-recruitment-detail/{{$row->id}}-{{$row->slug}}.html"><h4 style="text-align:left;font-size: 17px;font-family: verdana;"><b>{{mb_strtoupper($row->title)}}</b></h4></a>
                    ...
                    <div class="" style="padding: 0px 30px; position: absolute; right: 0;bottom: 0; text-align: right">
                        <a href="{{URL::asset('')}}ppc-recruitment-detail/{{$row->id}}-{{$row->slug}}.html" style="font-family: Verdana">{{trans('home.read_more')}}</a>
                    </div>
